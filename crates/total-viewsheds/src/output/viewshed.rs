...
mod test {
    ...
    fn viewshed_in_hole(backend: &crate::config::Backend) {
        ...
        match backend {
            crate::config::Backend::VulkanCPU => assert_viewshed(
                &viewshed,
                &[
                    "████████████████████████",
                    "████████████████████████",
            ...
            // TODO@ryan:
            //   Improve or ideally make this the same as mine. I don't think they have to be
            //   exactly the same, just near enough.
            crate::config::Backend::CPU => assert_viewshed(
                &viewshed,
                &[
                    "████████████████████████",
                    "██████▀▀█████▀▀█████████",
